/**
 * SOFIA Reform Knowledge Patch
 * 
 * Adiciona ao prompt da SOFIA o conhecimento sobre a reforma tributária
 * e a capacidade de usar o motor de inteligência para dar veredictos.
 * 
 * Este patch deve ser aplicado ao SOFIA_SYSTEM_PROMPT existente.
 */

export const SOFIA_REFORM_KNOWLEDGE = `
...
export const SOFIA_INTELLIGENCE_PROMPT_ADDITION = `

=== CONTEXTO DA SUPPLEY ===

A SUPPLEY é uma empresa de importação especializada em sourcing e desenvolvimento de produtos para construção civil, com foco em:
