...
export async function generateEstimativaExcel(
  ...
  const cols: ColDef[] = [
    ...
    { header: "DESCRIÇÃO", width: 34, value: (it: any) => it.description },
    { header: "NCM", width: 12, value: (it: any) => it.ncm },
    { header: "QTD", width: 9, value: (it: any) => it.quantity },
    { header: "UN", width: 6, value: (it: any) => it.unit },
    { header: "PREÇO UNIT FOB", width: 13, fmt: MONEY, value: (it: any) => it.unitPriceFob },
    { header: "TOTAL FOB", width: 13, fmt: MONEY, formula: (r: number) => `D${r}*F${r}`, value: (it: any) => it.totalFob },
    { header: "% VALOR", width: 10, fmt: PCT, formula: (r: number) => `G${r}/$D$4`, value: (it: any) => it.shareOfValue },
    { header: "FOB R$", width: 13, fmt: MONEY, formula: (r: number) => `G${r}*$D$3`, value: (it: any) => it.fobBrl },
    { header: "FRETE R$", width: 13, fmt: MONEY, formula: (r: number) => `$D$5*H${r}`, value: (it: any) => it.freightBrl },
    { header: "SEGURO R$", width: 11, fmt: MONEY, formula: (r: number) => `$D$6*H${r}`, value: (it: any) => it.insuranceBrl },
    { header: "VLR ADUANEIRO", width: 14, fmt: MONEY, formula: (r: number) => `I${r}+J${r}+K${r}`, value: (it: any) => it.customsValueBrl },
    { header: "AFRMM", width: 11, fmt: MONEY, formula: (r: number) => `$D$7*H${r}`, value: (it: any) => it.afrmmBrl },
    { header: "SISCOMEX", width: 10, fmt: MONEY, formula: (r: number) => `$D$8*H${r}`, value: (it: any) => it.siscomexBrl },
    { header: "DEMAIS DESP.", width: 12, fmt: MONEY, formula: (r: number) => `$D$9*H${r}`, value: (it: any) => it.demaisDespesasBrl },
    { header: "% II", width: 8, fmt: PCT, value: (it: any) => it.iiRate },
    { header: "VALOR II", width: 12, fmt: MONEY, formula: (r: number) => `L${r}*P${r}`, value: (it: any) => it.iiValue },
    { header: "% IPI", width: 8, fmt: PCT, value: (it: any) => it.ipiRate },
    { header: "VALOR IPI", width: 12, fmt: MONEY, formula: (r: number) => `(L${r}+Q${r})*R${r}`, value: (it: any) => it.ipiValue },
    { header: "% PIS", width: 8, fmt: PCT, value: (it: any) => it.pisRate },
    { header: "PIS-IMP", width: 12, fmt: MONEY, formula: (r: number) => `L${r}*T${r}`, value: (it: any) => it.pisValue },
    { header: "% COFINS", width: 9, fmt: PCT, value: (it: any) => it.cofinsRate },
    { header: "COFINS-IMP", width: 12, fmt: MONEY, formula: (r: number) => `L${r}*V${r}`, value: (it: any) => it.cofinsValue },
    { header: "BASE ICMS", width: 13, fmt: MONEY, formula: (r: number) => `(L${r}+M${r}+N${r}+Q${r}+S${r}+U${r}+W${r})/(1-$D$12)`, value: (it: any) => it.icmsBase },
    { header: "ICMS EFETIVO (TTD)", width: 14, fmt: MONEY, internalOnly: true, formula: (r: number) => `X${r}*$D$13`, value: (it: any) => it.icmsValue },
    { header: internalLabel("ICMS CLIENTE", internal), width: 14, fmt: MONEY, formula: (r: number) => `X${r}*$D$14`, value: (it: any) => it.icmsClienteValue },
    { header: "GANHO BENEFÍCIO", width: 14, fmt: MONEY, internalOnly: true, formula: (r: number) => colRef(cols, "ICMS CLIENTE", internal, r) , value: (it: any) => it.ganhoBeneficioIcms },
    { header: "CUSTO ANTES ASSESS.", width: 15, fmt: MONEY, value: (it: any) => it.totalCostBeforeAssessoria },
    { header: "ASSESSORIA", width: 12, fmt: MONEY, value: (it: any) => it.assessoriaValue },
    { header: "CUSTO TOTAL", width: 14, fmt: MONEY, value: (it: any) => it.totalCost },
    { header: "CRÉDITOS RECUP.", width: 14, fmt: MONEY, value: (it: any) => it.recoverableCredits },
    { header: "CUSTO LÍQUIDO", width: 14, fmt: MONEY, value: (it: any) => it.netTotalCost },
    { header: "CUSTO UNIT. LÍQ.", width: 13, fmt: MONEY, value: (it: any) => it.netUnitCost },
    { header: "PREÇO VENDA", width: 14, fmt: MONEY, value: (it: any) => it.salePrice },
    { header: "PREÇO UNIT.", width: 12, fmt: MONEY, value: (it: any) => it.saleUnitPrice },
    { header: "ICMS VENDA", width: 12, fmt: MONEY, formula: undefined, value: (it: any) => it.icmsVendaValue },
    { header: "IPI VENDA", width: 12, fmt: MONEY, value: (it: any) => it.ipiVendaValue },
    { header: "ICMS ST", width: 11, fmt: MONEY, value: (it: any) => it.icmsStValue },
    { header: "TOTAL NF VENDA", width: 14, fmt: MONEY, value: (it: any) => it.totalInvoiceValue },
