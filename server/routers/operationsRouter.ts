...
export const operationsRouter = router({
  ...
  update: protectedProcedure
    .input(z.object({
      ...
      modo: z.enum(["cotacao", "desenvolvimento"]).optional(),
      modal: z.enum(["maritimo", "aereo", "rodoviario", "ferroviario", "multimodal"]).nullable().optional(),
      incoterm: z.string().nullable().optional(),
      portoOrigem: z.string().nullable().optional(),
      portoDestino: z.string().nullable().optional(),
