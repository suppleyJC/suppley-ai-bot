...
export default function OperacaoFinanceiro({
  ...
  return (
    <section className="rounded-2xl border border-border bg-card p-5">
      ...
      {/* formulário */}
      {showForm && (
        <form onSubmit={handleSubmit} className="mb-4 space-y-3 rounded-xl border border-border bg-muted/60 p-3">
          <div className="grid grid-cols-2 gap-2">
            <label className="flex flex-col gap-1">
              <span className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Tipo</span>
              <select
            ...
            <label className="flex flex-col gap-1">
              <span className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Direção</span>
              <select
          ...
          <div className="grid grid-cols-2 gap-2">
            <label className="flex flex-col gap-1">
              <span className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Valor (R$)</span>
              <input
          ...
          <label className="flex flex-col gap-1">
            <span className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Descrição</span>
            <input
      ...
      {lancamentos.length === 0 ? (
        ...
        <ul className="space-y-2">
          {lancamentos.map((l) => {
            const st = STATUS_META[l.status] ?? { txt: l.status, cls: "bg-muted text-muted-foreground" };
