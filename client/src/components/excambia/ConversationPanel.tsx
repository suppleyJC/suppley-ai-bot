  ...
  return (
    <>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-2.5 pb-4">
        ...
        {operacoes.length > 0 && (
          <>
            <div className="sticky top-0 z-10 flex items-center bg-white px-2 pb-1.5 pt-3 text-[10px] font-bold uppercase tracking-wide text-slate-400">
              Operações
        ...
        {avulsas.length > 0 && (
          <>
            <div className="sticky top-0 z-10 bg-white px-2 pb-1.5 pt-4 text-[10px] font-bold uppercase tracking-wide text-slate-400">
              Conversas
            </div>
            {avulsas.map((c) => (
